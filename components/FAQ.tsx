  ...
  return (
    <div className="border-b border-black/5 last:border-0">
      ...
      >
        ...
        <span className={`ml-4 flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center border transition-all ${isOpen ? 'bg-red-600 border-red-600 text-white rotate-180' : 'bg-white/50 border-gray-200 text-gray-400'}`}>
...
const FAQ: React.FC = () => {
  ...
  return (
    // Changed: bg-white -> bg-white/50 backdrop-blur-lg border-white/40
    <div className="bg-white/50 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-sm border border-white/40 mb-12 animate-fade-in">
      ...
      <div className="max-w-3xl mx-auto bg-white/50 rounded-2xl p-6 md:p-8 border border-white/30">
        {faqs.map((faq, idx) => (
