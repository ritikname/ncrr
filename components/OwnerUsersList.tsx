...
const OwnerUsersList: React.FC<OwnerUsersListProps> = ({ users }) => {
  const handleWhatsAppClick = (phone: string) => {
    ...
    const text = "Hello! Thanks for stopping by ncrdrive.com. We saw you were checking out our premium selection. Whether you're planning a scenic road trip or need a sleek ride for a business meeting, I'm here to ensure you get the VIP treatment. How can I assist?";
