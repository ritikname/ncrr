    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-gray-900 overflow-x-hidden relative">
      ...
      <footer className="bg-black text-white mt-auto py-12">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
             <h4 className="font-bold text-lg text-white uppercase italic">Legal</h4>
             <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li className="hover:text-red-500 cursor-pointer transition-colors">Refund Policy</li>
             </ul>
             <div className="pt-4 text-xs text-gray-600">
                &copy; {new Date().getFullYear()} NCR Drive Rental Services.<br/>All rights reserved.
             </div>
          </div>
        </div>
      </footer>
