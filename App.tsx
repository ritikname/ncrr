...
export const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-gray-900 overflow-x-hidden relative">
             ...
             {viewMode === 'customer' || !user || user.role !== 'owner' ? (
                ...
                <div className="animate-fade-in space-y-8">
                  ...
                  {hasSearched ? (
                     <div id="fleet-section">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pb-12">
                           {filteredCars.length > 0 ? (
                              ...
                              <div className="col-span-full text-center py-20 text-gray-500 bg-white/60 backdrop-blur-md rounded-3xl border border-white/50">
                     ...
                     // Applied glass effect
                     <div className="text-center py-20 bg-white/40 backdrop-blur-xl rounded-3xl border border-white/50 shadow-sm">
                        <div className="w-20 h-20 bg-white/60 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl shadow-inner border border-white/30">
                           📅
                        </div>
                ...
                // --- OWNER VIEW (TABBED) ---
                <div className="animate-fade-in space-y-8">
                   <div className="bg-black/80 backdrop-blur-md text-white p-6 rounded-3xl text-center flex flex-col items-center justify-center relative border border-white/10">
                   ...
                   <div className="flex flex-wrap gap-2 bg-white/50 backdrop-blur-lg p-2 rounded-2xl shadow-sm border border-white/40 sticky top-20 z-40">
                      {[
                   ...
                   {(ownerTab === 'fleet' || ownerTab === 'bookings' || ownerTab === 'users') && (
                      <div className="relative">
                         <input 
                            ...
                            className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-600 outline-none shadow-sm bg-white/60 backdrop-blur-md"
                         />
                   ...
                   {ownerTab === 'fleet' && (
                      <div className="space-y-6 animate-fade-in">
                         {/* Collapsible Add Car Form - Glass */}
                         <div className="bg-white/60 backdrop-blur-md rounded-3xl border border-white/50 overflow-hidden shadow-sm">
                            <button 
                              onClick={() => setShowAddCarForm(!showAddCarForm)}
                              className="w-full p-4 flex items-center justify-between text-left font-bold text-gray-700 hover:bg-white/40 transition-colors"
                            >
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            {ownerCars.length > 0 ? (
                                ...
                                <div className="col-span-full py-24 text-center text-gray-400 bg-white/60 backdrop-blur-md rounded-3xl border border-dashed border-gray-300">
      ...
      <footer className="bg-black text-white mt-auto py-12 border-t border-white/10">
